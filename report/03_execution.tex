...
DEFLECT & rewrites the destination to a honeypot and installs the forward and reverse rules & the source is to be drawn off to a decoy rather than dropped \\
