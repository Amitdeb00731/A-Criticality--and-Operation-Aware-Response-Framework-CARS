...
THROTTLE & attaches a rate-limiting meter to the conduit (priority~100) & a SENSITIVE actuation, or a non-critical flood, that should be slowed rather than cut \\
