...
The design of the preceding sections is realised as an os-ken OpenFlow~1.3 controller, an Open vSwitch fabric and a Snort sensor, together with the pipeline of Section~\ref{sec:pipeline}. The mapping of these components onto the physical nodes is given in the Deployment section (Section~\ref{sec:deployment}). This section describes how each mechanism is built. The values quoted are read from the running system.
