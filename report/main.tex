...
\listoffigures
\listoftables
% \listofalgorithms   % omitted: the report floats no algorithm2e environments, so this list is empty
\lstlistoflistings
...
% ---- appendices ------------------------------------------------------------
\appendix
% ---- appendix floats: forbid top-of-page floats so a deferred figure can
% ---- never land above a continuing listing and split its box; figures fall
% ---- to a page bottom or their own float page instead --------------------
