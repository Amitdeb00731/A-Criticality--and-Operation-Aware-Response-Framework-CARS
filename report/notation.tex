...
A2 & The static proactive policy, the conduit allowlist and default-deny installed ahead of any reactive rule \\
MTTM & Mean time to mitigate (the reaction window from the attack frame on the wire to enforcement) \\
CVSS & Common Vulnerability Scoring System \\
SIL & Safety integrity level (as defined in IEC~61508) \\
DNP3 & Distributed Network Protocol~3 (a SCADA communication protocol) \\
