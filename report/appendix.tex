...
\caption{Criticality-scaled isolation timeout over 120 tier probes across the four runs. Every probe installed 75/60/45/30\,s for CRITICAL/HIGH/MEDIUM/LOW with no deviation, at a median engine decide-time of 0.50\,ms under the concurrent night-campaign load, against the 0.027\,ms of the dedicated clean run of Section~\ref{sec:evallatency}. Source: the four \texttt{night\_*} runs, reduced by \href{\repourl/blob/main/07_Evaluation/overnight/night/night_analyze.py}{\texttt{night\_analyze.py}}.}
