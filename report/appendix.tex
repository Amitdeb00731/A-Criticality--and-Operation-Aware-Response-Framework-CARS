...
\caption{Process transparency: the tank-level distribution armed against disarmed, over roughly seven thousand interleaved, load-matched per-second samples. The two distributions coincide (means 51.5 against 50.7\%) and neither leaves the control band, so arming the defence has no measurable effect on the process. Source: \href{\repourl/blob/main/07_Evaluation/overnight/results/e2/interleaved.csv}{\texttt{results/e2/interleaved.csv}}.}
