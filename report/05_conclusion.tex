...
Evaluate accuracy and false positives; validate each capability at the packet level, protected versus unprotected & 100\% decision accuracy, 0\% false positives; wire-level campaign across every capability; reaction window characterised (median 7.6\,ms) (Chapter~\ref{chap:evaluation}) \\
\hline
\end{tabular}
